...
export function IconCode({ size = 28, className }: IconProps) {
  return (
...
export function IconCloud({ size = 28, className }: IconProps) {
  return (
    <svg {...base(size)} className={className}>
...
export function IconHeadphones({ size = 28, className }: IconProps) {
  return (
    <svg {...base(size)} className={className}>
...
export function IconBolt({ size = 14, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M13 2L4.09 12.97a.5.5 0 00.39.82H11l-1 8.21a.5.5 0 00.91.31L19.91 11.36a.5.5 0 00-.39-.82H13l1-8.21A.5.5 0 0013 2z" />
    </svg>
  );
}
...
export function IconChat({ size = 14, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
